        ...
        $this->add_control( 'cards', [
            ...
            'default' => [
                [
                    ...
                    'title'       => __( 'Web Design', 'arenex-digital-widgets' ),
                    'description' => __( 'Clean, modern websites that capture your brand and turn visitors into customers.', 'arenex-digital-widgets' ),
                ...
                [
                    ...
                    'title'       => __( 'Brand Strategy', 'arenex-digital-widgets' ),
                    'description' => __( 'A clear, consistent identity that helps your business stand out and stay memorable.', 'arenex-digital-widgets' ),
                    'features'    => "Logo & Identity\nMessaging\nBrand Guidelines",
                    'link_text'   => __( 'Learn More', 'arenex-digital-widgets' ),
                    'link_url'    => [ 'url' => '' ],
                ],
                [
                    'icon'        => [ 'value' => 'fas fa-tv', 'library' => 'fa-solid' ],
                    'title'       => __( 'Development', 'arenex-digital-widgets' ),
                    'description' => __( 'Fast, reliable builds that bring your design to life with clean, scalable code.', 'arenex-digital-widgets' ),
                ...
                [
                    ...
                    'title'       => __( 'Marketing', 'arenex-digital-widgets' ),
                    'description' => __( 'Ongoing support and campaigns that keep your brand growing long after launch.', 'arenex-digital-widgets' ),
